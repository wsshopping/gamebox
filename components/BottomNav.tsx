...
const BottomNav: React.FC = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full z-50">
      ...
      */}
      <div className="bg-[#020617]/80 backdrop-blur-2xl border-t border-white/5 shadow-[0_-10px_30px_rgba(0,0,0,0.5)] flex justify-between px-6 py-2 pb-6 relative">
            ...
            {({ isActive }) => (
              <>
                 <div className={`relative transition-all duration-300`}>
                    {/* Active Background Glow - Subtle gold */}
