...
const Trade: React.FC<TradeProps> = ({ isEmbedded = false }) => {
  return (
    <div className={`bg-[#f8fafc] min-h-full ${isEmbedded ? '' : ''}`}>
      ...
      <button className="fixed bottom-28 right-5 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg shadow-violet-300 hover:scale-110 transition-all z-40 border-2 border-white group">
