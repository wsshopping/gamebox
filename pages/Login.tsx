  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center px-8 relative overflow-hidden">
      ...
      <div className="mb-10 animate-fade-in-up relative z-10">
        {/* Black Gold Logo */}
        <div className="w-16 h-16 bg-white rounded-[20px] flex items-center justify-center text-slate-700 mb-5 shadow-xl shadow-slate-200/70 relative overflow-hidden border border-slate-200">
        ...
        <h1 className="text-3xl font-black text-slate-900 tracking-tight">欢迎回到 <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-indigo-500">贪玩盒子</span></h1>
      ...
      <form onSubmit={handleLogin} className="space-y-6 animate-fade-in-up delay-100 relative z-10">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="bg-white rounded-2xl px-4 py-3 border border-slate-200 focus-within:border-sky-500/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-sky-500/10 transition-all">
              <input 
                type="tel" 
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <div className="bg-white rounded-2xl px-4 py-3 border border-slate-200 focus-within:border-sky-500/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-sky-500/10 transition-all flex-[0.65]">
                <input
                  type="text"
              ...
              <button
                type="button"
                onClick={loadCaptcha}
                className="h-[52px] flex-[0.35] min-w-[140px] rounded-xl overflow-hidden border border-slate-200 bg-white flex items-center justify-center text-xs text-slate-500"
              >
                {captchaImg ? (
        ...
        <button 
          ...
          className={`w-full bg-gradient-to-r from-sky-500 to-indigo-500 text-white py-4 rounded-2xl font-bold shadow-lg shadow-sky-300/60 transition-all flex items-center justify-center border border-sky-400/30 hover:shadow-sky-400/40 ${isSubmitting ? 'opacity-70 cursor-not-allowed scale-[0.98]' : 'hover:scale-[1.02] hover:shadow-sky-400/30'}`}
        >
          {isSubmitting ? (
            <>
