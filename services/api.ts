import { GAMES, TRADE_ITEMS, ARTICLES, TASKS, MESSAGES, SYSTEM_NOTIFICATIONS, INTERACTIONS, GROUPS } from './mockData';
...
/**
 * Unified API Service
 * In the future, replace the mock implementations with real axios/fetch calls.
 */
export const api = {
  // --- Game Related APIs ---
  game: {
  ...
  message: {
    ...
    getChatHistory: async (chatId: string): Promise<any[]> => {
      ...
      // Specifically for the "joined" group 'g1'
      if (chatId === 'g1') {
          return [
